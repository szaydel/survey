...
[![GoDoc](http://img.shields.io/badge/godoc-reference-5272B4.svg)](https://pkg.go.dev/github.com/szaydel/survey/v2)
...
`github.com/szaydel/survey/v2/terminal.InterruptErr` from `Ask` or `AskOne`.
